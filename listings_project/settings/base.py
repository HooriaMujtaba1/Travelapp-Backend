...
import dj_database_url  # Make sure this is imported for PostgreSQL
...
# === DATABASE ===
# Use dj_database_url to connect to PostgreSQL in production
DATABASES = {
    'default': dj_database_url.config(default=config('DATABASE_URL'))  # From Railway
}
...
CORS_ALLOWED_ORIGINS = [
    "https://your-frontend-app-url.com",  # Add your actual frontend URL
]
